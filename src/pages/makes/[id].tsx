...
import { Make, ResponseWrapper } from '@/interfaces/interfaces'
import { GetServerSideProps } from 'next'
import { isAxiosError } from 'axios'

interface ShowPageProp {
    data: Make
    err?: {
        statusCode?: number
    }
...
const Show = ({ data: selectedMake, err }: ShowPageProp) => {
...
export const getServerSideProps: GetServerSideProps = async context => {
    ...
    const { id } = query
    try {
        const res = await axios.get<ResponseWrapper<Make>>(`api/makes/${id}`, {
            headers: {
